...
class ManualLearner(object):
    ...
    def plot_performance_table(self,portvals_b, portvals_m, label_b, label_m, title="Performance Metrics",in_out_sample=None):
        """
    ...
    def mannual_run_sample_data(self,sd = dt.datetime(2008, 1, 1),
                         ed = dt.datetime(2009, 12, 31), plot_title="",in_out_sample=None,symbol = "JPM",start_val = 100000):
...
if __name__ == "__main__":  		  	   		 	 	 			  		 			 	 	 		 		 	
    ...
    ml.mannual_run_sample_data(sd=dt.datetime(2008, 1, 1), ed=dt.datetime(2009, 12, 31),
                     plot_title="Manual Strategy - In Sample",in_out_sample="In Sample",symbol="JPM",start_val=100000)  # Task 3

    # Out of Sample
    ml.mannual_run_sample_data(sd=dt.datetime(2010, 1, 1), ed=dt.datetime(2011, 12, 31),
                     plot_title="Manual Strategy - Out Sample",in_out_sample="Out Sample",symbol="JPM",start_val=100000)  # Task 4
